export const websiteCopy = {
  "zh-CN": {
    ...
    library: {
      overline: "个人资源库",
      title: "把协作中找到的依据，带到下一次工作里。",
      description:
        "按 Session 找回已发布的材料、原文批注和可访问的协作上下文。搜索、收藏、回看固定版本，再选出需要的内容，让自己的 Agent 按你的指令读取。",
      scope:
        "以 Kai 的视角展示的示意内容。资源库只整理当前有权访问的协作内容；个人原生 Session 不会自动收录。",
      previewLabel: "个人资源库交互示意",
      navigation: ["协作空间", "资源库", "设置与连接"],
      listTitle: "协作资源",
      viewsLabel: "资源视图",
      views: [
        { id: "recent", label: "最近使用" },
        { id: "participated", label: "我参与的" },
        { id: "annotated", label: "我批注的" },
      ...
      unfavorite: "取消收藏",
      searchLabel: "搜索示意资源",
      searchPlaceholder: "搜索材料、Session、批注…",
      noResults: "没有找到匹配的资源。",
      discussionLabel: "原文旁的讨论",
      selectedLabel: "已选",
      selectionNote: "由你选择内容 · 个人 Agent 按需读取",
      groups: [
        { id: "lin", title: "Lin 的 Codex Session" },
        { id: "mei", title: "Mei 的 Claude Code Session" },
        { id: "shared", title: "Lin 的共享 Codex Session" },
      ],
      resources: [
        {
          group: "lin",
          ...
          kind: "已发布材料",
          version: "固定版本 v1",
          source: "Lin · Codex Session · 只读分享",
          excerptLabel: "材料原文",
          excerpt: "回跳参数直接传给了跳转函数，还没有检查目标地址是否同源。",
          commentAuthor: "Kai",
          comment: "结合 Mei 的复现记录，这里也要检查 // 开头的地址。",
          selectLabel: "选择登录回跳调查 v1",
        },
        {
          group: "lin",
          type: "annotation",
          annotated: true,
          title: "Kai 的原文批注",
          subtitle: "关联登录回跳调查 v1",
          kind: "原文批注",
          version: "关联材料 v1",
          source: "登录回跳调查 · Lin 的 Codex Session",
          excerptLabel: "关联原文",
          excerpt: "回跳参数直接传给了跳转函数，还没有检查目标地址是否同源。",
          commentAuthor: "Kai",
          comment: "结合 Mei 的复现记录，这里也要检查 // 开头的地址。",
          selectLabel: "选择 Kai 的原文批注",
        },
        {
          group: "mei",
          type: "material",
          ...
          kind: "已发布材料",
          version: "固定版本 v1",
          source: "Mei · Claude Code Session · 已发布材料",
          excerptLabel: "材料原文",
          excerpt:
            "使用外部 URL 和协议相对地址都可以触发跳转，合法的站内路径应继续保留。",
          commentAuthor: "Lin",
          comment: "这与我定位的代码一致，可以把这两类地址一起补进检查。",
          selectLabel: "选择外部地址复现记录 v1",
        },
        {
          group: "shared",
          type: "context",
          annotated: false,
          title: "协作上下文",
          subtitle: "当前内容 · 读取时核对原文",
          kind: "协作上下文",
          version: "实时内容",
          source: "Lin · 共享 Codex Session · 共同执行",
          excerptLabel: "当前上下文",
          excerpt:
            "共享会话正在补上对外部地址和协议相对地址的检查，同时保留合法的站内路径。执行仍留在 Lin 的 Mac。",
          commentAuthor: "",
          comment: "",
          selectLabel: "选择协作上下文",
        },
    ...
    start: {
      ...
      download: "下载 macOS 版",
      requirements: "macOS 14+ · Apple Silicon · v0.2.2 正式版",
  ...
  en: {
    ...
    library: {
      ...
      title: "Bring what your team found into the next task.",
      description:
        "Find published material, inline comments, and collaboration context you can access, grouped by Session. Search, save favorites, revisit fixed versions, then choose what your own Agent reads when you ask.",
      scope:
        "Example content from Kai's perspective. The library includes collaboration material you can currently access; it does not automatically collect private native Sessions.",
      previewLabel: "Interactive example of the personal library",
      navigation: ["Collaboration spaces", "Library", "Settings & connections"],
      listTitle: "Collaboration resources",
      viewsLabel: "Library views",
      views: [
        { id: "recent", label: "Recently used" },
        { id: "participated", label: "I participated" },
        { id: "annotated", label: "I commented" },
      ...
      searchLabel: "Search example resources",
      searchPlaceholder: "Search material, Sessions, comments…",
      noResults: "No matching resources.",
      discussionLabel: "Discussion beside the source",
      selectedLabel: "Selected",
      selectionNote: "You choose the material · Your Agent reads it on request",
      groups: [
        { id: "lin", title: "Lin's Codex Session" },
        { id: "mei", title: "Mei's Claude Code Session" },
        { id: "shared", title: "Lin's shared Codex Session" },
      ],
      resources: [
        {
          group: "lin",
          ...
          annotated: true,
          title: "Sign-in redirect investigation",
          subtitle: "Published material · v1",
          kind: "Published material",
          version: "Fixed version v1",
          source: "Lin · Codex Session · Read-only sharing",
          excerptLabel: "Source passage",
          excerpt:
            "The redirect parameter is passed straight to the navigation function without checking whether the target is same-origin.",
          commentAuthor: "Kai",
          comment:
            "Mei's reproduction shows that protocol-relative URLs need to be checked here too.",
          selectLabel: "Select sign-in redirect investigation v1",
        },
        {
          group: "lin",
          type: "annotation",
          annotated: true,
          title: "Kai's inline comment",
          subtitle: "Linked to sign-in redirect investigation v1",
          kind: "Inline comment",
          version: "Linked material v1",
          source: "Sign-in redirect investigation · Lin's Codex Session",
          excerptLabel: "Linked source passage",
          excerpt:
            "The redirect parameter is passed straight to the navigation function without checking whether the target is same-origin.",
          commentAuthor: "Kai",
          comment:
            "Mei's reproduction shows that protocol-relative URLs need to be checked here too.",
          selectLabel: "Select Kai's inline comment",
        },
        {
          group: "mei",
          type: "material",
          ...
          kind: "Published material",
          version: "Fixed version v1",
          source: "Mei · Claude Code Session · Published material",
          excerptLabel: "Source passage",
          excerpt:
            "Both external URLs and protocol-relative URLs trigger a redirect. Valid internal paths still need to work.",
          commentAuthor: "Lin",
          comment:
            "This matches the code I found. We can cover both external forms in the same check.",
          selectLabel: "Select external redirect reproduction v1",
        },
        {
          group: "shared",
          type: "context",
          ...
          subtitle: "Current content · Verify when reading",
          kind: "Collaboration context",
          version: "Live content",
          source: "Lin · Shared Codex Session · Joint execution",
          excerptLabel: "Current context",
          excerpt:
            "The shared Session is adding checks for external and protocol-relative redirects while keeping valid internal paths. Execution remains on Lin's Mac.",
          commentAuthor: "",
          comment: "",
          selectLabel: "Select collaboration context",
        },
      ],
    },
    connection: {
    ...
    start: {
      ...
      requirements: "macOS 14+ · Apple Silicon · v0.2.2 stable release",
